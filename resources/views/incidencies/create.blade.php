                            ...
                            <div class="col-3">
                                <div class="row">
                                    <label for="num_incident" class="col-12 col-form-label">Numero</label>
                                        <div class="col-10">
                                            <input type="number" class="form-control" id="num_incident" name="num_incident" required>
                                        </div>
                            ...
                            <div class="col-3">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        ...
                                        maxlength="9" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                                    </div>
                            ...
                            <div class="col-3">
                                <div class="row">
                                    <label for="alertants_id" class="col-12 col-form-label">Alertant</label>
                                        ...
                                        <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Caller">
                                                ?
                                        </button>
                                </div>
                            </div>
