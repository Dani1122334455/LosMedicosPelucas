...
<div class="container-fluid">
    <div class="card mt-3">
        <div class="card-body">
        <h5 class="card-title font-weight-bold">Editar Incidencia</h5>
            <form action="{{ action([App\Http\Controllers\IncidenciesController::class,'update'],['incidency'=>$incidency->id]) }}" method="POST">
                @csrf
                @method('PUT')
                    <div class="form-group row">
                        ...
                        <div class="col-sm-11">
                            ...
                            value="{{ $incidency->num_incident }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="data" class="col-sm-1 col-form-label">Data</label>
                        <div class="col-sm-11">
                            <input type="date" class="form-control" id="data" name="data" value="{{ $incidency->data }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="hora" class="col-sm-1 col-form-label">Hora</label>
                        <div class="col-sm-11">
                            <input type="time" class="form-control" id="hora" name="hora" value="{{ $incidency->hora }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-11">
                            ...
                            value="{{ $incidency->telefon_alertant }}">
                        </div>
                        </div>
                    <div class="form-group row">
                        <label for="adreca" class="col-sm-1 col-form-label">Adreça</label>
                        <div class="col-sm-11">
                            <input type="text" class="form-control" id="adreca" name="adreca" value="{{ $incidency->adreca }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="adreca_complement" class="col-sm-1 col-form-label">Adreça complement</label>
                        <div class="col-sm-11">
                            <input type="text" class="form-control" id="adreca_complement" name="adreca_complement"
                            value="{{ $incidency->adreca_complement }}">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-11">
                            <input type="text" class="form-control" id="descripcio" name="descripcio" value="{{ $incidency->descripcio }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nom_metge" class="col-sm-1 col-form-label">Metge</label>
                        <div class="col-sm-11">
                            <input type="text" class="form-control" id="nom_metge" name="nom_metge" value="{{ $incidency->nom_metge }}">
                        </div>
                    </div>
                    <div class="form-group row">
